/** Theo docs/posttest2.docx — 8 chủ đề Section B, mỗi chủ đề 15 câu */

export const POSTTEST_TOPIC_IDS = [
...
const TOPIC_SET = new Set(POSTTEST_TOPIC_IDS)
 ...
 */
export function validatePosttestBody(body) {
