## TÍnh năng mà người dùng mong muốn ở chatbot
- Là một user, tui muốn biết về kế hoạch nộp journal [cite Trần Hoàng Nam (@NamTran) - report trong technical error]
- Là một user, tui muốn biết về Model đang được sử dụng ??
